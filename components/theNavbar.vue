<template>
  <header>
    <nav>
      <router-link to="/">
        <svg height="32" width="127" class="logo-bg">
          <mask fill="#fff">
            <path d="M0 0h32.042v32H0z" fill-rule="evenodd"></path>
          </mask><g fill="none" fill-rule="evenodd">
          ...
          <path d="M4.005 0A4.014 4.014 0 000 4v24c0 2.2 1.802 4 4.005 4h24.032c2.203 0 4.005-1.8 4.005-4V4c0-2.2-1.802-4-4.005-4z" fill="#e44332" mask="url(#td-logo-wordmark_svg__a)">
          </path>
          <g fill="#fff">
      ...
      >
        <ul>
          ...
          <li class="popup-menu-auth-link-sm">
            <router-link to="/users/showlogin">Login</router-link>
          </li>
          <li class="popup-menu-auth-link-sm register-action">
            <router-link to="/users/showsignup">Sign up</router-link>
          </li>
        </ul>
      </div>
      ...
      <div class="menu-items">
        ...
        <ul class="menu-auth" v-if="!showPopUpMenu">
          <li>
            <router-link to="/users/showlogin" active-class="active"
            >Login</router-link
            >
          </li>
          <li>
